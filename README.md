...
-   **전략:**
    1.  **승객 탑승 시:** 맨 처음 태운 승객의 목적지로만 이동합니다. (다른 승객 고려 X)
    2.  **대기 시:** 0층부터 순서대로 탐색하여 가장 먼저 발견되는 호출로 이동합니다.
-   **약점:** 매우 비효율적이고 근시안적인 움직임을 보입니다.

### 🤖 중급 봇: "가까운 것만 보여"

-   **전략:**
    1.  **승객 탑승 시:** 현재 위치에서 가장 가까운 목적지를 가진 승객을 우선 처리합니다.
    2.  **대기 시:** 현재 위치에서 가장 가까운 호출에 응답합니다.
-   **약점:** 엘리베이터의 '이동 방향'을 고려하지 않아, 비효율적인 방향 전환이 잦습니다.
